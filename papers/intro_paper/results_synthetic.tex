...
\abhi{Divided up this section into three clear indepenent segments. each segment has a plot associated with it.}

\abhi{segment 1: discuss the recovery of nonGR signals to establish the robustness of the pipeline}
...
\abhi{segment 2: discuss possible systematics by recoving a nonGR signal using a GR template}
...
\abhi{segment 3: discuss possible correlations between GR and nonGR quantities as you increase deviation. Also discuss the SNRs recovered}.
Finally, we investigate the impact on the estimation of GR parameters discussed in Sec.~\ref{sec:method}, $\bxigr$  as we change the magnitude of deviation in the non-GR parameters. For comparison, we also consider a synthetic signal with $\df{220} = \dtau{220} = 0.5$, or 50 \% deviation, along with the 10\% non-GR signal and a signal with no deviation (essentially GR) mentioned above. 




\comment{AB: Not clear to me the next sentence. We are working
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure*}%[h!]
        \includegraphics[width=0.5\textwidth]{figures/GW150914_simulated_signal_0p0_0p1_0p5_gr_m1m2.png}\includegraphics[width=0.5\textwidth]{figures/GW190521_simulated_signal_0p0_0p1_0p5_gr_m1m2.png}
        \includegraphics[width=0.5\textwidth]{figures/GW150914_simulated_signal_0p0_0p1_0p5_gr_a1za2z.png}\includegraphics[width=0.5\textwidth]{figures/GW190521_simulated_signal_0p0_0p1_0p5_gr_a1za2z.png}
        \includegraphics[width=0.5\textwidth]{figures/GW150914_simulated_signal_0p0_0p1_0p5_gr_fgrtaugr.png}\includegraphics[width=0.5\textwidth]{figures/GW190521_simulated_signal_0p0_0p1_0p5_gr_fgrtaugr.png}
        \includegraphics[width=0.5\textwidth]{figures/GW150914_simulated_signal_0p0_0p1_0p5_gr_fngrtaungr.png}\includegraphics[width=0.5\textwidth]{figures/GW190521_simulated_signal_0p0_0p1_0p5_gr_fngrtaungr.png}
