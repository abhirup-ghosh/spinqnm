...
\subsection{\ab{Synthetic-signal injections in General Relativity with Gaussian noise}}\label{ssec:gr_signal}
...
\begin{tabular}{ |c|c|c|c|c|c| }
 \hline
 Event & $m_{1,d} (\Mo)$ &  $m_{2,d} (\Mo)$ & $\chi_{1}$ & $\chi_{2}$ & SNR \\ 
 \hline
 ...
 \hline
\end{tabular}
\caption{\ab{Parameters of the synthetic-signal injections}, chosen to be similar to the actual GW events indicated in teh first column. The parameters 
$(m_{1,d},m_{2,d})$ are the detector-frame masses of the primary and secondary BHs, respectively.}
...
\comment{AB: Nothing is said in the text about the third mock signal in the Table!}
