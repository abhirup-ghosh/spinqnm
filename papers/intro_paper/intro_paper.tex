...
$(\df{220}, \dtau{220})$. Such strong degeneracy \textcolor{blue}{(which arises from the fact that the frequency and damping time inverse are proportional to the total mass such that one can always obtain the same frequency or damping time by appropriately increasing the total mass and the deviation parameters in the same direction)} is present for
