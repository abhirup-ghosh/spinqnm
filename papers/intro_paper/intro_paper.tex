...
\begin{abstract}
 ...
 \sout{outlines a} \ab{that proposed to} 
  ...
  constraints yet using this
  method. %Finally, we also present a investigation into possible systematic effects due to an incomplete understanding of the interferometric noise around the GW event on the results of this test.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%
...
black holes (BHs), collectively called compact binary coalescences
...
from} \ab{after} the first \sout{ever direct} detection of GWs \ab{passing through the} \sout{on} Earth, on September 14,
2015~\citep{abbott2016observation}.
\par
