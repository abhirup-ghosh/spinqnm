...
\caption{The median and symmetric 90\% credible intervals of the frequency and damping time of the $(2,\pm2)$ QNM \comment{AB: I believe it should be just $(2,2)$.}, and the mass and spin of the remnant object estimated from 
the QNM frequencies \ab{using the $\pSEOB$ model. We indicate with a star the GW events that were analysed in this paper, the other events were examined in Ref.~\cite{Abbott:2020jks}.} 
\comment{AB: I would add the mass and spin of the remnant from NR fits, as well. The final mass should be multiplied by $(1+z)$. Correct?}}
