...
the QNM frequencies using the $\pSEOB$ model. We indicate with a star the GW events that were analysed in this paper, the other events were examined in Ref.~\cite{Abbott:2020jks}. \abhi{[AG: There aren't Mf-chif-IMR results for 0630 in the GWTC-2 TGR paper, probably because PyRING did not run on it. The current values are from the GWTC-2 catalog paper. The numbre is red is source-frame; needs to be converted to detector-frame.]}}
