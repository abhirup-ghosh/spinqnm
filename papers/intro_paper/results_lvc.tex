...
However, \rb{in most non-GR theories,} the deviations parameters $(\df{220},\dtau{220})$ depend in general on the source's parameters, so \rb{if GR were to be wrong, one should expect their value to vary} across the GW signals observed by LIGO and Virgo.
