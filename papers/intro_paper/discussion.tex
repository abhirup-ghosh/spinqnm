...
constraints are compatible, but sligthly better (especially for the decay time) that the ones recently reported in Ref.~\cite{Carullo:2021dui} 
(see first row in Table II therein), where measurements on QNMs were done using only the post-merger part of 
the signal, and included a larger set of GW events from O1, O2 and O3a.}
