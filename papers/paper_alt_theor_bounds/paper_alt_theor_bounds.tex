...
%
Since the scalar field is coupled to a curvature scalar, $Q$ is larger (smaller)
...
to dimension-eight operators ($n=4$),
%
\begin{subequations}
...
%
Due to the large number of free parameters in this theory, we will work only with a subset of the theory's
parameter space.
%
...
spin-expansion coefficients (ParSpec) expansion in
Sec.~\ref{sec:review_parspec}.
%
Next, in Sec.~\ref{sec:review_pSEOB}, we will review our full
inspiral-(plunge)-merger-ringdown (IMR) BBH waveform model we
use~\cite{Brito:2018rfr,Ghosh:2021mrv} and explain how we include the ParSpec
expansion into it.
%
...
%
Ultimately, this provides with an IMR BBH waveform model, with the ringdown
informed with QNM calculations in specific beyond-GR theories.
