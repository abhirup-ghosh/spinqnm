...
between the QNM spectra of polar and axial gravitational perturbations of
...
%
The coupling strength between scalar field and the Pontryagin density is set by the
coupling constant $\ell_{\rm CS}$, with dimensions of length.
