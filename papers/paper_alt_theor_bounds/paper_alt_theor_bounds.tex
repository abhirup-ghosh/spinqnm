...
other gravity considered here~\cite{Pierini:2021jxd,Cano:2021myl}.
%
...
\hline
EdGB      & 4 & 0.0107 & 0.0044 & \dots & \dots &  \cite{Pierini:2021jxd} & $\ell_{\rm GB} \leqslant 1.18$~km~(GW)~\cite{Lyu:2022gdr} & \dots \\
dCS      & 4 & 3.1964 & 6.3619 & \dots & \dots &  \cite{Wagle:2021tam}   & $\ell_{\rm CS} \leqslant 8.5$~km~(EM+GW)~\cite{Silva:2020acr}  & $\ell_{\rm CS} \leqslant 34.5$~km \\
...
is based on obtaining a kernel density estimator (KDE) as an approximation for
the posterior distribution on $\ell$ for each individual events. These are then
multiplied together to yield the cumulative posterior.
%
