...
\end{equation}
%
where $p_j(\ell_{\rm th} | \mathcal{H})$ are the priors used for each observation, \redsout{and} $p(\ell_{\rm th} | \mathcal{H})$ is an overall prior, and we assume that the value of $\ell_{\rm th}$ is shared among all events.
%
