...
\hscomm{Alessandra, I moved the plot here as we discussed.}
%
In Fig.~\ref{fig:corner_plot}, we show the final spin $\chi_{\rm f}$ and
remnant mass $M_{\rm f}$ for GW150914 for GR and dCS gravity.
%
We see that indeed our waveform models does not introduce substantial changes
to the GR estimates on these parameters, as required by the ParSpec expansion
(see discussion in Sec.~\ref{sec:review_parspec}).
%
We observed the same in all other theories we studied.
...
%
\hs{We found that the inclusion of the spin corrections produced waveforms which for $\ell_{\rm qEFT} \gtrsim 80$~km
had a ringdown segment larger (sometimes seconds long) that the inspiral-plugne segment.}
...
We found, in particular, that within the interpretation these theories as EFTs and the
...
%
This dichotomy between the two theories has an analogy with works that considered
the inspiral part of the GW signal alone.
%
In that case, it is dCS gravity which cannot be constrained with current GW
events, while EdGB can, as shown in Refs.~\cite{Nair:2019iur,Perkins:2021mhb,Lyu:2022gdr}.
%
