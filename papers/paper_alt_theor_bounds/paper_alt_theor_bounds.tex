...
This theory belongs to the class of scalar-Gauss-Bonnet theories, described by
the action
%
...
scalar and $\varphi$ is a dynamical, massless scalar field that couples to the
...
done through function $f(\varphi)$. The strength of the coupling is
...
%
This is the case of Einstein-dilaton-Gauss-Bonnet (EdGB) gravity, for which $f = \exp(\varphi)$.
%
...
solution of GR and scalarized BHs~\cite{Doneva:2017bvd,Silva:2017uqg,Dima:2020yac,Herdeiro:2020wei,Berti:2020kgk}.
%
Examples include the quadratic $f \propto \varphi^2$~\cite{Silva:2017uqg}
and Gaussian $f \propto \exp(-\varphi^2)$~\cite{Doneva:2017bvd} coupling functions.

BHs in both classes of theories have hair, to which we can associate a (monopole) scalar charge,
related to the asymptotic $1/r$ decay of the scalar field.
%
This charge is not an independent parameter, and depends on the BH's mass and spin,
thus being a ``secondary charge''~\cite{Coleman:1991ku,Herdeiro:2015waa}.
%
Since the scalar field is coupled to a curvature invariant, the scalar charge is larger (smaller)
the smaller (larger) the BH's mass is.

These properties are not mere theoretical curiosities, but have important observational consequences.
%
First, the presence of the scalar charge implies that when in binaries, BHs can source
scalar dipole radiation~\cite{Yagi:2011xp,Julie:2019sab,Shiralilou:2020gah,Shiralilou:2021mfl,Julie:2022huo} making
the theory prone to be constraint with present
GWs observations of BH binaries (BBH)~\cite{Nair:2019iur,Perkins:2021mhb,Lyu:2022gdr}.
%
Second, the scalar field does influence the response of BHs to linearized perturbations in this theory,
affecting their QNM spectra.
...
and gravitational perturbations of polar parity.
%
BH QNMs in EdGB gravity were first computed in Refs.~\cite{Pani:2009wy,Blazquez-Salcedo:2016enn} and these calculations
were extended to leading-order in BH spin effects in Ref.~\cite{Pierini:2021jxd}.
