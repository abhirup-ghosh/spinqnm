...
We now describe the waveform model used in our paper to measure properties of a
BBH ringdown.
%
...
The merger-ringdown waveform, $h_{l m}^\mathrm{merger-RD}$, is then stitched to
inspiral-plunge waveform, $h_{l m}^\mathrm{insp-plunge}$ at a certain time $t = t^{\textrm{match}}_{l m}$, as
%
\begin{equation}
h_{l m}(t) =
