...
\hline
\hline
Theory                  & GR~\cite{Maselli:2019mjd} \\
\hline
...
\hline
\hline
Theory                        & EdGB ($p=4$)~\cite{Blazquez-Salcedo:2016enn,Pierini:2021jxd} & dCS ($p=4$)~\cite{Wagle:2021tam} & cubic EFT ($p=4$)~\cite{Cano:2021myl} & quartic EFT ($p=6$)~\cite{Cano:2021myl} \\
\hline
