...
of the \hs{dominant axial gravitational-led} mode increases as the coupling constant
$\ell_{\rm EdGB}$ is increased. The leading-order spin corrections to the
polar-branch of QNMs was studied in Ref.~\cite{Pierini:2021jxd}.
%
Hence, according to the prescription of Sec.~\ref{sec:theory_specific_qnm},
\hs{we select the axial-parity branch of QNMs.}
