...
related to the asymptotic $1/r$ fall-off of the scalar field.
%
...
%
Since the scalar field is coupled to a curvature scalar, the $Q$ is larger (smaller)
...
charges of binary components. This makes EdGB gravity testable with present GWs
...
% nonrotating BHs. The reason is due to
...
between the QNM spectra of polar and axial gravitational perturbations (isospectrality) of
Schwarzschild BHs in GR.
%
...
This theory is described by the action~\cite{Jackiw:2003pm},
%
...
%
As in scalar-Gauss-Bonnet theories, $\int \dV {}^{*}RR$ alone is a boundary term~\cite{Jackiw:2003pm},
hence cannot contribute to the field equations in four-dimensions.
%
However, this terms can modify the theory's field equation by coupling it to
$\vartheta$.
%
The coupling strength set by the coupling constant $\ell_{\rm CS}$, with
dimensions of length.

The theory admits same the garden-variety Schwarzschild BH solution of
GR~\cite{Jackiw:2003pm}, but admits non-Kerr solutions for spinning BHs~\cite{Yunes:2009hc,Konno:2009kg}.
%
These BHs carry secondary scalar hair, which, unlike in EdGB gravity, is
dipolar.
%
As a consequence, the leading-scalar radiative channel of BBH to lose energy is quadrupolar,
which affects the GW phase at 2PN order.
%
...
%
However, the theory has been constrained by Ref.~\cite{Silva:2020acr}, that found
%
...
neutron star (BNS) GW170817~\cite{TheLIGOScientific:2017qsa}.
...
Our last example of modified gravity theories are the so-called effective field theories (EFT) of GR.
