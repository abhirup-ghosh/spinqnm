...
signal-to-noise ratio, allowing us to probe the relaxation of the remnant black
...
% What we do:
Here, we take a first step to address this question, by using an
...
%
We give a prescription on to include to this waveform model the quasinormal mode frequencies
calculated on a theory-by-theory basis, in particular, for theories that deviate
from general relativity through higher-curvature corrections, namely,
...
%
% Main conclusion:
We confront the resultant waveform models against GW150914 and GW200129 data,
finding that while Einstein-dilaton-Gauss-Bonnet cannot be constrained with
...
%
The latter result constitutes a concrete example of a theory presently
unconstrained by inspiral-only analyses which, however, can be constrained by
merger-ringdown studies.
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%
