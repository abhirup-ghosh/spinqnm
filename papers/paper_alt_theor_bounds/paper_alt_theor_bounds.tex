...
Monte Carlo algorithm~\cite{Rover:2006ni,vanderSluys:2008qx,Veitch:2014wba,lalsuite}.
%
...
Suppose we have a set of $N$ GW detections $\{D_{i}\}$ described by model parameters $\bm{\lambda}$.
%
