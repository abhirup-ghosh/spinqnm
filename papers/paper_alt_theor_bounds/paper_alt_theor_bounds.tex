...
In Fig.~\ref{fig:example_waveform} we show an illustrative waveform for the case of the cubic EFT
of gravity include the leading-order $n = 0$ deformations to the fundamental QNM.

\begin{figure}[t]
\includegraphics[width=\columnwidth]{figs/example_waveform_cubicEFT.pdf}
\caption{(Color online).~Example of an waveform.}
