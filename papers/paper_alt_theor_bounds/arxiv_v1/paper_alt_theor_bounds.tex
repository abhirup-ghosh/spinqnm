...
EFTs of GR~\cite{Endlich:2017tqa,Sennett:2019bpc,Cano:2019ore,Brandhuber:2019qpg,AccettulliHuber:2020dal,deRham:2020ejn,Cano:2020cao,Cano:2021myl}.
%
...
to use the posteriors on $\ell_{\rm th}$, considering up to $j=2$ in
...
%
We will see in Sec.~\ref{sec:results} that adding theory-specific
...
\begin{figure}[htb]
\includegraphics[width=\columnwidth]{example_waveform_cubicEFT.pdf}
...
(merger-ringdown) SNRs which are both $\approx 16$ (see the columns for
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{edgb_posteriors_combined.pdf}
...
\begin{figure}[h]
\includegraphics[width=\columnwidth]{edgb_gamma.pdf}
...
\begin{figure}[h]
\includegraphics[width=\columnwidth]{edgb_cdf_varying_threshold.pdf}
...
which found that $p=4$ modifications (such as the case of EdGB gravity)
...
Furthermore, Ref.~\cite{Carullo:2021dui} did not impose the EFT bound that we imposed.
%
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{dcs_posteriors_combined.pdf}
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{dcs_cdf_varying_threshold.pdf}
...
\begin{figure}[t]
\includegraphics[width=0.9\columnwidth]{GW150914_intrinsic_params_remnant.pdf}
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{ceft_posteriors_combined.pdf}
...
%
\begin{figure}[h]
\includegraphics[width=\columnwidth]{ceft_cdf_varying_threshold.pdf}
...
%
\begin{figure}[t]
\includegraphics[width=\columnwidth]{qeft_posteriors_combined.pdf}
...
\begin{figure}[t]
\includegraphics[width=\columnwidth]{qeft_cdf_varying_threshold.pdf}
...
\begin{figure*}[t]
\includegraphics[width=0.9\textwidth]{GW150914_intrinsic_params.pdf}
