...
outdir = '../plots/SEOBNRv4HM_range/omega220_10percent'

omega220_list = np.linspace(omega220 - 0.5*omega220, omega220 + 0.5*omega220, 11)

for omega220 in omega220_list:
	# Generate the modes
	...
	plt.hold(True)
	#plt.savefig(outdir + '/omega220_%.2f_modes.png'%omega220)
	#plt.close()
	...
	plt.hold(True)
	#plt.savefig(outdir + '/omega220_%.2f_waveform.png'%omega220)
        #plt.close()
	"""
plt.savefig(outdir + '/omega220_50percent_range.png')
